...
<p align="justify"><b>NACIT DISCUSSION FORUM(NDF)</b> is a discussion forum that gives information about various subjects, related questions, information related to the departments and faculties. </p>

<p align="justify">This forum is useful for the beginners to get information  related to  various topics. There is a centralized database in which all the information is managed. The administrator acts as the highest authority and has the rights to update the database.</p> 
                                ...
                                <div class="art-BlockHeader">
                                    ...
                                    <div class="art-BlockContent-body">
                                      <marquee direction="up" onmouseover="stop()" onmouseout="start()" scrollamount="1" scrolldelay="1" style="height:400px;">  <div>
                                                          ...
                                                          University Student Help Forum.<br/>
